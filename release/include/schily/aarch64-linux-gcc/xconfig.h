...
#define HAVE_WCSLCAT 1		/* wcsncat() is present in libc */
#define HAVE_WCSLCPY 1		/* wcsncpy() is present in libc */
...
#define DEV_MINOR_BITS 20		/* # if bits needed to hold minor device number */
...
/* #undef HAVE_SIGSTKSZ_CONST */	/* SIGSTKSZ is a constant */
 ...
 */
#define HOST_ALIAS "aarch64-unknown-linux-gnu"		/* Output from config.guess (orig)	*/
#define HOST_SUB "aarch64-unknown-linux-gnu"			/* Output from config.sub (modified)	*/
#define HOST_CPU "aarch64"			/* CPU part from HOST_SUB		*/
